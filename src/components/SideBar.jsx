      ...
      <div className="fixed z-10 py-4 px-3 bg-gray-50 shadow-md shadow-slate-400 rounded dark:bg-gray-800" id="fixedSideBar">
        ...
        <div className='flex flex-col justify-between h-[76vh]' data-sidebar="list-parent">
          <ul className="space-y-2">
            <li>
              <Link to="/" className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-slate-100 hover:border-l-2 hover:border-slate-500 ${title === 'Dashboard' && 'bg-emerald-100 hover:bg-emerald-200 dark:bg-emerald-900 dark:hover:bg-emerald-800 border-l-2 border-emerald-500 hover:border-emerald-600 dark:hover:border-emerald-400'} dark:hover:border-slate-200 transition-all duration-150 dark:hover:bg-gray-700`}>
            ...
            <li>
              <Link to="/inbox" className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-slate-100 hover:border-l-2 hover:border-slate-500 dark:hover:border-slate-200 ${title === 'Inbox' && 'bg-emerald-100 hover:bg-emerald-200 dark:bg-emerald-900 dark:hover:bg-emerald-800 border-l-2 border-emerald-500 hover:border-emerald-600 dark:hover:border-emerald-400'} transition-all duration-150 dark:hover:bg-gray-700`}>
            ...
            <li>
              <Link to="/customers" className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-slate-100 hover:border-l-2 hover:border-slate-500 dark:hover:border-slate-200 ${title === 'Customers' && 'bg-emerald-100 hover:bg-emerald-200 dark:bg-emerald-900 dark:hover:bg-emerald-800 border-l-2 border-emerald-500 hover:border-emerald-600 dark:hover:border-emerald-400'} transition-all duration-150 dark:hover:bg-gray-700`}>
            ...
            <li>
              <Link to="/products" className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-slate-100 hover:border-l-2 hover:border-slate-500 dark:hover:border-slate-200 ${title === 'Products' && 'bg-emerald-100 hover:bg-emerald-200 dark:bg-emerald-900 dark:hover:bg-emerald-800 border-l-2 border-emerald-500 hover:border-emerald-600 dark:hover:border-emerald-400'} transition-all duration-150 dark:hover:bg-gray-700`}>
          ...
          <div>
            <button className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-red-100 hover:border-l-2 hover:border-red-500 dark:hover:border-red-200 transition-all duration-150 dark:hover:bg-red-900 w-full">
